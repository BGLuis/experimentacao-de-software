...
export default function RQ03() {
  ...
  const chartData = useMemo(() => {
    ...
    .map(d => {
      ...
      return { releases: d.releases, stars: d.estrelas, language: lang };
    });
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-200">
        <h3 className="text-lg md:text-xl font-semibold mb-4 text-gray-800">Total de Releases x Estrelas</h3>
