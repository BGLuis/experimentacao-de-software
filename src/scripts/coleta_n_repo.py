...
query MetricasRepositorio($owner: String!, $name: String!) {
  repository(owner: $owner, name: $name) {
    nameWithOwner url stargazerCount createdAt updatedAt
...
def salvar_csv(repositorios: list[dict]) -> None:
    campos = ["repositorio", "url", "estrelas", "criado_em", "idade_dias", "atualizado_em", "dias_desde_atualizacao", "linguagem_primaria", "pull_requests_aceitas", "releases", "issues_abertas", "issues_fechadas", "issues_total", "razao_issues_fechadas"]
    ...
    with ARQUIVO_CSV.open("w", encoding="utf-8", newline="") as arquivo:
        ...
        for repositorio in repositorios:
            ...
            writer.writerow({
                "repositorio": repositorio["nameWithOwner"], "url": repositorio["url"],
                "estrelas": repositorio["stargazerCount"], "criado_em": repositorio["createdAt"],
                "idade_dias": (agora - criado).days, "atualizado_em": repositorio["updatedAt"],
                ...
                "releases": repositorio["releases"]["totalCount"], "issues_abertas": abertas,
                "issues_fechadas": fechadas, "issues_total": total_issues,
